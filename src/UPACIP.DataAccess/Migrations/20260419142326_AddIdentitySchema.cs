    ...
    public partial class AddIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-7a8b-9c0d-e1f2a3b4c5d6"), "a1b2c3d4-e5f6-7a8b-9c0d-e1f2a3b4c5d6", "End-user patient portal access — read-only appointment and record visibility.", "Patient", "PATIENT" },
                    { new Guid("b2c3d4e5-f6a7-8b9c-0d1e-f2a3b4c5d6e7"), "b2c3d4e5-f6a7-8b9c-0d1e-f2a3b4c5d6e7", "Clinical staff — schedule management, appointment actions, and patient record access.", "Staff", "STAFF" },
                    { new Guid("c3d4e5f6-a7b8-9c0d-1e2f-a3b4c5d6e7f8"), "c3d4e5f6-a7b8-9c0d-1e2f-a3b4c5d6e7f8", "Platform administrator — full system access including user management and configuration.", "Admin", "ADMIN" }
                });
